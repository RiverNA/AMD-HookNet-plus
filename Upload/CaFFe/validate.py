...
from data import reconstruct_from_patches_and_binarize
from data import postprocess_zone_segmenation, postprocess_front_segmenation, \
...
def main(mode, patch_test_directory, complete_test_directory, complete_postprocessed_test_directory,
    ...
    reconstruct_from_patches_and_binarize(src_directory=patch_test_directory, dst_directory=complete_test_directory,
                                          # modality=model.hparams.target_masks,
                                          modality='zones',
                                          threshold_front_prob=threshold_front_prob)
    ...
    # calculate_segmentation_metrics(model.hparams.target_masks, complete_predicted_masks, complete_test_directory, directory_of_complete_targets)

    calculate_segmentation_metrics('zones', complete_predicted_masks, complete_test_directory, directory_of_complete_targets)
