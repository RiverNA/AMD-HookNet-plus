...
An inference example for calculating the Hausdorff distance, MDE, and IoU using [CaFFe](https://github.com/Nora-Go/Calving_Fronts_and_Where_to_Find_Them): see `EVAL_CAFFE.py`
